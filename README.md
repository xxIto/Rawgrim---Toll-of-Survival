...
```text
[https://github.com/xxlto/Rawgrim---Toll-of-Survival/releases/latest/download/module.json](https://github.com/xxIto/Rawgrim---Toll-of-Survival/releases/download/v1.0.0/module.json)
```
